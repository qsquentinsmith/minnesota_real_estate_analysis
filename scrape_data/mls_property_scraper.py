...
def scrape_property(url, pid, address):
    ...
    description = extract_el('span.detail.publicremarks.remarks') #listing description
...
for (i, row) in df_properties.iterrows():
    ...
    try:
        THE_MLS_PROPERTY_URL_FORMAT = 'https://www.themlsonline.com/minnesota-real-estate/listings/property/%s/%s'
